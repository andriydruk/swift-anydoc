...
@Suite struct PdfEndToEndTests {
    ...
    private static let matching: Set<String> = [
        ...
        "font-type3-text.pdf", "text-rise.pdf", "xref-zeroed.pdf", "overlay-bullet.pdf", "overlay-bullet-plain.pdf", "overlay-backtrack.pdf", "overlay-plain.pdf", "table-marker-merged.pdf",
