...
@Suite struct PdfEndToEndTests {
    ...
    private static let matching: Set<String> = [
        ...
        "decode-texcm-symbols.pdf", "garbled-text-document.pdf", "font-cid-to-gid.pdf", "font-post-names.pdf", "rotated-text-page.pdf", "content-comments.pdf",
        "crop-box.pdf", "inline-image.pdf", "object-stream.pdf",
        "font-type3-text.pdf", "text-rise.pdf", "xref-zeroed.pdf", "zw-nonalpha-near.pdf", "zw-beyond-bailout.pdf",
        "zw-samecase.pdf", "zw-lower-upper.pdf", "zw-upper-lower.pdf", "overlay-bullet.pdf", "overlay-bullet-plain.pdf", "overlay-backtrack.pdf", "overlay-plain.pdf", "table-marker-merged.pdf",
        "table-marker-word.pdf", "table-marker-separate.pdf", "struct-names-bare.pdf", "cmap-usecmap.pdf", "cmap-plain.pdf", "wrapped-bold-heading.pdf", "nested-list.pdf",
        "numbered-list.pdf", "cjk-single-run.pdf", "cjk-split-runs.pdf",
        "cjk-mixed-latin.pdf", "cjk-word-spacing.pdf", "invisible-chars.pdf",
        "typographic-spaces.pdf", "rtl-pure.pdf", "rtl-two-runs.pdf",
        "rtl-mixed.pdf", "rtl-base-letters.pdf", "rtl-forms-a.pdf", "cols-two-column.pdf", "cols-negative-size.pdf", "style-italic-angle.pdf",
        "style-italic-flag.pdf", "style-forcebold.pdf", "style-both.pdf",
        "style-angle-below.pdf", "style-angle-at-four.pdf", "ocg-hidden.pdf", "ocg-visible.pdf",
        "cid-identity-v.pdf", "font-type1-fontfile.pdf", "offpage-text.pdf",
        "neg-font-size.pdf", "shading-op.pdf", "link-over-text.pdf", "link-apart.pdf", "tu-partial-disagree.pdf",
        "tu-partial-highbyte.pdf", "tu-partial-full.pdf", "gid-tounicode-rescue.pdf", "gid-all-pages.pdf", "gid-two-page.pdf",
        "gid-name-nondigit.pdf", "gid-name-bare.pdf", "glyph-ligatures.pdf",
        "glyph-control.pdf", "glyph-fallback-forms.pdf", "enc-win.pdf", "enc-mac.pdf",
        "enc-std.pdf", "enc-none.pdf", "enc-symbol-name.pdf", "cid-japan1-fallback.pdf",
        "cid-identity-ordering.pdf", "cid-unijis.pdf", "cid-truetype-promoted.pdf",
        "cid-truetype-absent.pdf", "cid-to-gid-repair.pdf",
        "cid-to-gid-absent.pdf", "cid-subset-remap.pdf",
        "cid-subset-remap-covered.pdf", "page-rotate-attr.pdf",
        "inherited-page-tree.pdf", "incremental-update.pdf",
